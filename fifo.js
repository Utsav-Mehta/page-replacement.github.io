$(document).ready(function(){
    ...
    $("#btn1").click(function(){
        if(flag==0){
            ...
            var temp=0;
            for(var i=0;i<faults.length-1;i++){
                if(faults[i]<faults[i+1]){
                    document.querySelector("#last").innerHTML="<li>Belady's Anomaly exists for the set of frames entered.</li>";
                    temp=1;
                    break;
                }
            }
    ...
    btn.addEventListener("click", function(){
        ...
        for(var k=0;k<com.length;k++){
            ...
            ul.appendChild(li);
            // var li=document.createElement("li");
            // li.textContent="Does FIFO suffer from Belady's Anomaly? Yes";
            // ul.appendChild(li);
            ...
            for(var i=0;i<n;i++){
                ...
                // adding colours according to hit/fault
        ...
        document.querySelector("#btn1").innerHTML="<button><span style='background:#827ffe'>Show Graph</span></button>";
